...
?>
    ...
    <section class="s-content s-content--narrow s-content--no-padding-bottom">
        ...
        <article class="row format-standard">
            ...
            $philosophy_upload_meta_info = get_post_meta(get_the_ID(),'page-upload-metabox',true);

            echo esc_html( $philosophy_upload_meta_info['page-upload']).'<br/>';

            echo $philosophy_upload_meta_info['page-image'].'<br/>';

            echo wp_get_attachment_image($philosophy_upload_meta_info['page-image'],'medium').'<br/>';

            echo wp_get_attachment_image_src($philosophy_upload_meta_info['page-image'],'medium')[0];
