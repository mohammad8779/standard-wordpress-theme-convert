...
?>
    ...
    <section class="s-content s-content--narrow s-content--no-padding-bottom">
        ...
        <article class="row format-standard">
            ...
            $philosophy_page_gallery_info = get_post_meta(get_the_ID(),'page-upload-metabox',true);

            echo $philosophy_page_gallery_info['page-gallery'];

            if($philosophy_page_gallery_info['page-gallery']){

                $philosophy_page_gallery_ids = explode(',', $philosophy_page_gallery_info['page-gallery']);

                foreach($philosophy_page_gallery_ids as $philosophy_page_gallery_id){

                    echo "<br/>";
                    echo wp_get_attachment_image($philosophy_page_gallery_id,'medium');
