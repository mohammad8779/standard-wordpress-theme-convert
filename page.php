...
?>
    ...
    <section class="s-content s-content--narrow s-content--no-padding-bottom">
        ...
        <article class="row format-standard">
            ...
            $philosophy_page_meta_info = get_post_meta(get_the_ID(),'page-metabox',true);

            echo esc_html( $philosophy_page_meta_info['page-heading']).'<br/>';
            echo esc_html( $philosophy_page_meta_info['page-teaser']).'<br/>';


            if($philosophy_page_meta_info['is-favorite']){

                echo esc_html( $philosophy_page_meta_info['is-favorite-text']);
            }
